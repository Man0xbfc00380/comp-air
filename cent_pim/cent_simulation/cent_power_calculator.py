...
def command_processor(stat_path):
    ...
    if stat["cycles"] > 0:
        ...
        # Keep downstream flow alive when a trace has no simulated cycles.
        stat["utilization"] = 0.00
        print(f"Warning: memory_system_cycles is 0 in log {stat_path}. Utilization is set to 0.")
    return stat
