...
class TransformerBlock(PIM):
    ...
    def set_exp_config(self, use_noc, use_sram_pim):
        self.use_comp_air_sram_pim = use_sram_pim
        self.use_comp_air_noc = use_noc
    ...
    def Vector_Matrix_Mul_weight_pim_only_trace(self, channel_lst, row_index_matrix, vector_dim, matrix_col, total_banks, timing):
        ...
        # print("\n[GeMV]", "vec", vector_dim, "mat_col", matrix_col, "banks", total_banks)
        # print("[GeMV]", "row/vec", rows_per_vector, "mat_col/bank", matrix_col_per_bank, "util_banks", utilized_banks)
