...
class TransformerBlockLlama(TransformerBlock):
    ...
    def self_attention_aim(self):
        ...
        if self.pim_compute:
            ...
            if self.GQA:
                print("self_attention self_attention_aim:289")
        ...
        if self.pim_compute:
            ...
            if debug:
                ...
                values = self.cache_v[:bsz, : self.start_pos + seqlen]
                if self.GQA:
                    print("self_attention self_attention_aim:306")
                    keys = repeat_kv(keys, self.n_repeat)
                    values = repeat_kv(values, self.n_repeat)
    ...
    def trace_only(self):
        ...
        if self.trace_activation:
            ...
            # print("[iteration_required]", iteration_required, ffn_dim, self.channels_per_block ,"*", (self.num_banks // 4) ,"*", self.DRAM_column)
            if iteration_required:
                # Very Large Model
