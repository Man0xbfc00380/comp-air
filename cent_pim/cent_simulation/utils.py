...
n_heads = {"Llama2-7B": 32, "Llama2-13B": 40, "Llama2-70B": 64, "Qwen": 64, "GPT3-175B": 96} # Qwen = Qwen2.5-72B
gqa_factor = {"Llama2-7B": 1, "Llama2-13B": 1, "Llama2-70B": 8, "Qwen": 8, "GPT3-175B": 1}
embedding_size = {"Llama2-7B": 4096, "Llama2-13B": 5120, "Llama2-70B": 8192, "GPT3-175B": 12288, "GPT3-175B-TP-8": 12288, "OPT-66B": 9216, "Qwen": 8192}
ffn_size = {"Llama2-7B": 11008, "Llama2-13B": 13824, "Llama2-70B": 28672, "GPT3-175B": 12288*4, "GPT3-175B-TP-8": 12288*4, "OPT-66B": 9216*4, "Qwen": 29568}
filename = {"Llama2-7B": "../datasets/LLaMA-2-7B.pth", "Llama2-13B": "../datasets/LLaMA-2-13B.pth", "Llama2-70B": "../datasets/LLaMA-2-70B.pth"}
TransformerBlock_number = {"Llama2-7B": 32, "Llama2-13B": 40, "Llama2-70B": 80, "Qwen": 80, "GPT3-175B": 96}
minimal_channel_per_block = {"Llama2-7B": 5, "Llama2-13B": 8, "Llama2-70B": 6, "Qwen": 6, "GPT3-175B": 8}
...
def generate_args_func_sim():
    ...
    parser.add_argument("--GEMV", choices=["reuse-GB", "reuse-bank", "no-reuse"], help="GEMV choice, inner product keeps accumulation results and re-write GB, outer product keeps GB and re-write accumulation register.", default="reuse-GB")
    parser.add_argument("--reuse-size", type=int, help="reuse size for either reuse-GB or reuse-bank, depends on number of MAC register size", default=32)
    ...
    parser.add_argument("--op-trace", action="store_true", help="Print operation traces", default=True)
    parser.add_argument("--only-trace", action="store_true", help="Skip functional verification and only generate memory trace", default=True)
    ...
    parser.add_argument("--Llama-GQA", action="store_true", help="Llama2 70B and Llama3", default=True)
    ...
    parser.add_argument("--Qwen", action="store_true", help="Qwen")
    ...
    parser.add_argument("--multi-tb-per-device", action="store_true", default=True)
    parser.add_argument("--ffn_dim", type=int, help="FFN dimension", default=11008)
    parser.add_argument("--n_heads", type=int, help="Number of heads", default=32)
    ...
    parser.add_argument("--pipeline-parallel", action="store_true", default=True)
    parser.add_argument("--channels-per-block", type=int, help="Channles required for a Transformer Block", default=32)
